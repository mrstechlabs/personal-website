...
const projects = [
  {
    title: 'wapiflow',
    description: 'A modern API integration platform that simplifies webhook management and workflow automation. Built with Next.js, TypeScript, and real-time database sync.',
  ...
  {
    title: 'TutorAsia',
    description: 'An online tutoring platform connecting students with expert tutors. Features video sessions, progress tracking, and interactive learning tools.',
  ...
  },
  {
    ...
    description: 'A utility tool that analyzes device battery health and gives recommendations for optimal performance.',
  ...
  },
  {
    ...
    description: 'An elegant app delivering daily motivational quotes with sharing, favorites, and personalized themes.',
    ...
    <section id="projects" className="section-wrapper">
      <div className="max-w-5xl mx-auto">
        ...
        >
          ...
          <Link
            href="/products"
            className="link-arrow shrink-0 self-start sm:self-end"
          >
            All projects
